    ...
    {
        return getComputedStyle(document.getElementById(id)).getPropertyValue(cssKey);
    };
    ...
    Ytils.YupputHtml.visibleOrInvisibleElement = function(elem, visibility, excMsg) {
        ...
        if (elem && elem.style) {
            ...
            Ytils.YupputHelper.thrErr("Ytils.YupputHtml.visibleElement() expects parameter elem to be an instance of HTMLObjectElement.");
        }
