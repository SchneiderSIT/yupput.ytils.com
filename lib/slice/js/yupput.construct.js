    ...
    var construct = function(values) {
        ...
        stopPropagateDblClick = god(config,"stopPropagateDblClick") || DEFAULT_STOP_PROPAGATE_DBLCLICK;
        ...
        yyh.expectAz09Char(ctrlShiftChar, "Ytils.Yupput expects config option .ctrlShiftChar to be a single char within a-z, A-Z or 0-9.");
        yyh.expectFunctionOrNull(callbackOnChange, "Ytils.Yupput expects config option .callbackOnChange to be a function.");
